...
return [
    ...
    // Hero Section
    'hero_title' => 'Votre façade, Notre mission',
    'hero_subtitle' => 'Expert en nettoyage et rénovation de façades en Belgique',
    'hero_cta' => 'Demander un devis gratuit',
    'hero_cta_secondary' => 'Nos services',

    // Services
    'services_title' => 'Nos Services',
    'services_subtitle' => 'Des solutions complètes pour vos façades',

    'service_scaffolding_title' => 'Échafaudage',
    'service_scaffolding_desc' => 'Placement et installation d\'échafaudages sécurisés pour tous vos travaux en hauteur',

    'service_cleaning_title' => 'Nettoyage',
    'service_cleaning_desc' => 'Sablage et hydrogommage professionnels pour redonner vie à vos façades',

    'service_repair_title' => 'Réparation',
    'service_repair_desc' => 'Réparation experte de façades abîmées, fissures et dégradations',

    'service_painting_title' => 'Peinture',
    'service_painting_desc' => 'Peinture professionnelle de façades avec des produits de haute qualité',

    'service_protection_title' => 'Protection',
    'service_protection_desc' => 'Traitement anti-humidité et protection anti-graffitis durables',

    // Portfolio
    'portfolio_title' => 'Nos Réalisations',
    'portfolio_subtitle' => 'Découvrez nos projets avant/après',
    'before' => 'Avant',
    'after' => 'Après',
    ...
    'about_desc' => 'SVS RENOV est une entreprise spécialisée dans le nettoyage et la rénovation de façades en Belgique. Fort de nombreuses années d\'expérience, nous offrons des services de qualité professionnelle avec des résultats durables.',
    'our_values' => 'Nos Valeurs',
    'value_quality' => 'Qualité',
    'value_quality_desc' => 'Travail soigné avec des matériaux premium',
    'value_expertise' => 'Expertise',
    'value_expertise_desc' => 'Équipe qualifiée et expérimentée',
    'value_reliability' => 'Fiabilité',
    'value_reliability_desc' => 'Respect des délais et engagement',
    ...
    // Footer
    'footer_description' => 'Expert en nettoyage et rénovation de façades',
    ...
    // Refonte 2026 : navigation & header
    'nav_realisations' => 'Réalisations',
    'blog' => 'Conseils',
    'nav_quote_cta' => 'Devis gratuit',
    'nav_call' => 'Appeler',
    'footer_tagline' => 'Spécialiste en rénovation de façades en Belgique',
    'footer_legal_vat' => 'TVA',

    // Refonte 2026 : hero
    'hero_badge_zone' => 'Meise · Bruxelles · Brabant flamand',
    'hero_heading_1' => 'Votre façade,',
    'hero_heading_2' => 'notre mission.',
    'hero_lead' => 'Nettoyage, réparation, hydrofugation et peinture de façades. Un seul interlocuteur, du premier échafaudage au dernier coup de pinceau.',
    'hero_stat_years' => 'ans d\'expérience',
    'hero_stat_rating' => 'note Google',
    'hero_stat_quote' => 'devis sans engagement',
    'hero_stat_quote_value' => 'Gratuit',
    'hero_drag_hint' => 'Glissez pour comparer',

    // Refonte 2026 : avis
    'reviews_eyebrow' => 'Avis clients',
    'reviews_title' => 'Ils nous ont confié leur façade',
    'reviews_based_on' => 'sur',
    'reviews_count_label' => 'avis Google',
    'reviews_see_all' => 'Voir tous les avis sur Google',
    'reviews_close' => 'Fermer',

    // Refonte 2026 : page service
    'service_detail_related' => 'Réalisations pour ce service',
    'service_detail_other' => 'Nos autres services',
    'service_detail_cta_title' => 'Un projet de ce type ?',
    'service_detail_cta_text' => 'Visite sur place et devis gratuits, sans engagement.',
    'service_detail_back' => 'Tous les services',

    // Refonte 2026 : blog
    'blog_eyebrow' => 'Conseils & actualités',
    'blog_title' => 'Le blog façade',
    'blog_subtitle' => 'Entretien, techniques, conseils de pro : tout pour garder une façade en bonne santé.',
    'blog_read_more' => 'Lire l\'article',
    'blog_min_read' => 'min de lecture',
    'blog_empty' => 'Les premiers articles arrivent bientôt.',
    'blog_back' => 'Tous les articles',
    'blog_related' => 'À lire aussi',
    'blog_cta_title' => 'Votre façade a besoin d\'un coup de neuf ?',
    'blog_cta_text' => 'Demandez une visite gratuite : on vous dit honnêtement ce qu\'il faut faire (et ce qui peut attendre).',
    'home_blog_title' => 'Derniers conseils',
    'home_blog_link' => 'Voir tous les articles',

    // SEO : titres et descriptions pour Google
    'seo_home_title' => 'Nettoyage et rénovation de façades à Bruxelles et Meise',
    'seo_home_desc' => 'SVS Renov nettoie, répare, protège et peint votre façade à Bruxelles, Meise et dans le Brabant flamand. Échafaudage, hydrogommage, hydrofugation. Devis gratuit.',
    'seo_about_title' => 'À propos : votre façadier à Meise',
    'seo_about_desc' => 'Découvrez SVS Renov : une entreprise familiale spécialisée dans le nettoyage et la rénovation de façades à Bruxelles et dans le Brabant flamand.',
    'seo_services_title' => 'Nos services de rénovation de façades',
    'seo_services_desc' => 'Échafaudage, nettoyage, hydrogommage, réparation, hydrofugation, peinture et anti-graffiti : tous nos services pour votre façade, avec devis gratuit.',
    'seo_portfolio_title' => 'Nos réalisations avant / après',
    'seo_portfolio_desc' => 'Découvrez nos chantiers de façades en images avant / après : nettoyage, réparation, hydrofugation et peinture à Bruxelles et environs.',
    'seo_gallery_title' => 'Galerie photos et vidéos de nos chantiers',
    'seo_gallery_desc' => 'Photos et vidéos de nos chantiers de façades, de notre matériel et de nos équipes sur le terrain.',
    'seo_contact_title' => 'Contact et devis gratuit',
    'seo_contact_desc' => 'Demandez votre devis gratuit et sans engagement pour votre façade. Appelez le 0472 64 06 79 ou envoyez-nous un message.',

    // Refonte 2026 : pages Services, Réalisations, À propos, Contact, Galerie
    'services_page_lead' => 'Du nettoyage à la protection, en passant par la réparation et la peinture : chaque façade reçoit la technique adaptée à son support.',
    'services_process_eyebrow' => 'Notre méthode',
    'services_process_title' => 'Un chantier sans surprise',
    'services_step1_title' => 'Visite gratuite',
    'services_step1_desc' => 'On vient voir votre façade, on écoute vos attentes et on identifie le bon traitement.',
    'services_step2_title' => 'Devis détaillé',
    'services_step2_desc' => 'Un devis clair, poste par poste, sans engagement.',
    'services_step3_title' => 'Travaux soignés',
    'services_step3_desc' => 'Échafaudage sécurisé, protection des abords, finitions contrôlées.',
    'services_step4_title' => 'Réception ensemble',
    'services_step4_desc' => 'On fait le tour du chantier avec vous avant de clôturer.',
    'portfolio_page_lead' => 'Glissez le curseur sur chaque photo pour comparer l’avant et l’après.',
    'portfolio_view_photos' => 'Voir les photos du chantier',
    'portfolio_photos' => 'photos',
    'portfolio_empty' => 'Nos réalisations arrivent bientôt.',
    'portfolio_close' => 'Fermer',
    'portfolio_prev' => 'Photo précédente',
    'portfolio_next' => 'Photo suivante',
    'about_founder_label' => 'Fondateur',
    'about_values_eyebrow' => 'Nos valeurs',
    'about_values_title' => 'Ce qui nous guide sur chaque chantier',
    'contact_page_lead' => 'Visite et devis gratuits, sans engagement. Réponse sous 24h.',
    'contact_required_hint' => '* champs obligatoires',
    'contact_sending' => 'Envoi en cours…',
    'contact_privacy' => 'Vos coordonnées servent uniquement à répondre à votre demande.',
    'contact_details_title' => 'Nos coordonnées',
