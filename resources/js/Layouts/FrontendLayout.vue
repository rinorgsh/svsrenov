...
<template>
    <div class="flex min-h-screen flex-col overflow-x-hidden bg-white pb-[72px] lg:pb-0">
        ...
        <div class="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white/95 px-4 pt-3 backdrop-blur-lg lg:hidden" style="padding-bottom: max(0.75rem, env(safe-area-inset-bottom))">
            <div class="mx-auto grid max-w-md grid-cols-2 gap-3">
                <a
                    href="tel:+32472640679"
                    class="flex items-center justify-center gap-2 rounded-full border border-secondary/15 py-3 text-sm font-semibold text-secondary"
                >
