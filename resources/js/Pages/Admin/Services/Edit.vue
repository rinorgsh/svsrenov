...
const form = useForm({
    ...
    title_fr: props.service.title_fr,
    title_nl: props.service.title_nl,
    description_fr: props.service.description_fr,
    description_nl: props.service.description_nl,
    long_description_fr: props.service.long_description_fr || '',
    long_description_nl: props.service.long_description_nl || '',
    image: null,
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow-md p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div v-if="service.image" class="md:col-span-2">
                        ...
                        <img :src="service.image" :alt="service.title_fr" class="h-40 rounded-lg shadow-md">
                    </div>

                    <!-- Image Upload -->
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            {{ service.image ? 'Changer l\'image' : 'Ajouter une image' }}
                        </label>
                        <input
                            type="file"
