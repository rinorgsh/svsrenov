...
<template>
    <section v-if="reviews?.length" class="overflow-hidden border-t border-line/10 bg-surface py-14 md:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex flex-col md:mb-12 items-center text-center">
                <span class="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-accent">{{ t('reviews_eyebrow') }}</span>
                <h2 class="max-w-2xl text-[1.7rem] font-extrabold leading-tight text-fg sm:text-4xl md:text-5xl">
                    {{ t('reviews_title') }}
                </h2>
